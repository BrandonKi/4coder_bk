                            ...
                            ARGB_Color color, Cursor_Type type)
{
    ...
    else
	{
		...
		draw_rectangle(app, side, 0, color);
	}
}
                         ...
                         Rect_f32 *rect, Rect_f32 *last_rect, Rect_f32 target)
{
    ...
    *last_rect = *rect;
    ...
    b32 should_animate_cursor = false;
                           ...
                           f32 roundness, f32 outline_thickness, Frame_Info frame_info)
{
    ...
    b32 has_highlight_range = draw_highlight_range(app, view_id, buffer, text_layout_id, 0);
    ...
    if (*highlight_buffer != 0){
        if (*highlight_buffer != buffer){
            ...
            if (managed_object_load_data(app, *highlight, 0, 2, marker_range)){
                ...
                draw_character_block(app, text_layout_id, range, 0,
                             ...
                             f32 roundness, f32 outline_thickness, Frame_Info frame_info)
{
    ...
    if(!has_highlight_range)
    {
        ...
        // NOTE(rjf): Draw cursor
        {
            ...
            draw_rectangle(app, global_cursor_rect, 0, ghost_color);
            draw_rectangle(app, rect, 0, cursor_color);
        }
    }
}
